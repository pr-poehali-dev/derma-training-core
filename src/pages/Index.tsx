...
const diseases: Disease[] = [
  ...
  {
    name: "Сифилис", category: "Инфекционное", prevalence: "6.3 на 100 тыс.", icon: "🔺",
    color: "from-rose-50 to-red-50", badge: "bg-rose-100 text-rose-700",
    icd: "A51–A53",
    definition: "Хроническое системное инфекционное заболевание, вызываемое Treponema pallidum. Передаётся половым, трансплацентарным и (редко) бытовым путём. Протекает стадийно с поражением кожи, слизистых, нервной и сердечно-сосудистой систем.",
    etiology: "Возбудитель: Treponema pallidum subsp. pallidum — грамотрицательная спирохета, не культивируется in vitro. Пути передачи: половой (95%), вертикальный (трансплацентарный — врождённый сифилис), гемотрансфузионный (крайне редко). Инкубационный период: 10–90 дней (в среднем 21 день).",
    pathogenesis: "T. pallidum проникает через микроповреждения слизистых/кожи → размножение в месте внедрения → твёрдый шанкр (первичный аффект). Гематогенная и лимфогенная диссеминация → вторичный сифилис (6–8 нед). Формирование гранулём (гуммы) при третичном сифилисе. Нейросифилис возможен на любой стадии.",
    clinicalFeatures: "Первичный: твёрдый шанкр — безболезненная эрозия/язва с плотным основанием и ровными краями, регионарный лимфаденит. Вторичный (через 6–8 нед): розеолёзная сыпь на туловище, папулёзные сифилиды, широкие кондиломы, алопеция, «ожерелье Венеры» (лейкодерма). Третичный (3–15 лет): бугорковые сифилиды, гуммы кожи и внутренних органов. Нейросифилис: менингит, спинная сухотка, прогрессивный паралич.",
    diagnostics: "Нетрепонемные тесты (скрининг): RPR, VDRL — количественные, для контроля лечения. Трепонемные тесты (подтверждение): ИФА (IgM+IgG), РПГА, РИФ, иммуноблот. Алгоритм: скрининг ИФА → подтверждение RPR с титром. Прямые методы: темнопольная микроскопия (шанкр), ПЦР. Нейросифилис: люмбальная пункция (цитоз, белок, VDRL ликвора).",
    differentialDiagnosis: "Первичный: генитальный герпес (болезненные везикулы), шанкроид (болезненная язва, подрытые края), травматическая эрозия. Вторичный: розовый лишай Жибера (медальон), каплевидный псориаз, токсикодермия, ВИЧ-экзантема. Третичный: туберкулёз кожи, лейшманиоз, глубокие микозы.",
    treatment: "Ранний сифилис (до 2 лет): бензатин бензилпенициллин 2.4 млн ЕД в/м однократно (первичный) или трёхкратно с интервалом 7 дней (вторичный, ранний латентный). Поздний: бензилпенициллин натриевая соль 1 млн ЕД × 6 р/сут в/м 28 дней. Нейросифилис: бензилпенициллин 12–24 млн ЕД/сут в/в 14 дней. Аллергия на пенициллин: доксициклин 100 мг × 2 р/д 14–28 дней или десенсибилизация к пенициллину (нейросифилис). Контроль: RPR каждые 3 мес — снижение титра в 4 раза за 6–12 мес.",
    prognosis: "Ранний сифилис: полное излечение при адекватной терапии. Серорезистентность (сохранение нетрепонемных антител) у 10–15%. Поздний/нейросифилис: возможны необратимые поражения. Врождённый сифилис: тяжёлые пороки развития. Обязательное обследование и лечение половых партнёров."
  },
  {
    name: "Крапивница", category: "Аллергическое", prevalence: "15–25% в течение жизни", icon: "⚡",
    color: "from-pink-50 to-rose-50", badge: "bg-pink-100 text-pink-700",
    icd: "L50",
    definition: "Группа заболеваний, характеризующихся появлением зудящих волдырей (уртикарий) и/или ангиоотёка. Острая — до 6 недель, хроническая — более 6 недель.",
    etiology: "Острая: пищевые аллергены (орехи, морепродукты, яйца), лекарства (НПВС, антибиотики, рентгеноконтрастные средства), инфекции, укусы насекомых. Хроническая спонтанная: аутоиммунная (анти-IgE, анти-FcεRI антитела) — 30–50%, идиопатическая. Индуцированная: холод, давление, солнце, вибрация, холинергическая (пот, стресс).",
    pathogenesis: "Активация тучных клеток → дегрануляция → высвобождение гистамина, лейкотриенов, простагландинов → вазодилатация, повышение проницаемости сосудов → отёк дермы (волдырь) или подкожной клетчатки/слизистых (ангиоотёк). Аутоиммунный механизм: IgG-аутоантитела к IgE или FcεRI на тучных клетках.",
    clinicalFeatures: "Волдыри: бледно-розовые/белые возвышающиеся элементы с эритематозным ободком, интенсивный зуд. Ключевой признак: полное разрешение каждого элемента в течение 24 часов без следов. Ангиоотёк: асимметричный отёк губ, век, языка, гортани (опасно!), гениталий; длительность 24–72 часа. Анафилаксия: крапивница + гипотензия + бронхоспазм + ангиоотёк.",
    diagnostics: "Острая: анамнез (связь с аллергеном), аллергообследование (прик-тесты, sIgE). Хроническая (>6 нед): ОАК+СОЭ/СРБ, ТТГ, анти-ТПО, тест с аутологичной сывороткой (ASST), D-димер/C3/C4 (исключение уртикарного васкулита). UAS7 — оценка активности (баллы зуда + волдырей за 7 дней). Биопсия при подозрении на уртикарный васкулит (волдырь >24 ч, жжение, остаточная пигментация).",
    differentialDiagnosis: "Уртикарный васкулит (волдыри >24 ч, жжение > зуда, остаточная пурпура, ↓ комплемент), многоформная эритема (мишеневидные элементы), контактный дерматит (стойкая эритема), буллёзный пемфигоид (уртикарная стадия), мастоцитоз (пигментная крапивница, симптом Дарье). Наследственный ангиоотёк: ↓ C4, ↓ C1-ингибитор — НЕ отвечает на антигистаминные!",
    treatment: "1 линия: H1-антигистаминные 2 поколения (цетиризин, левоцетиризин, дезлоратадин) в стандартной дозе. 2 линия: повышение дозы до 4× (off-label, но рекомендовано EAACI). 3 линия: омализумаб (anti-IgE) 300 мг п/к каждые 4 нед. 4 линия: циклоспорин 3–5 мг/кг/д. Острая тяжёлая / анафилаксия: адреналин 0.3–0.5 мг в/м, ГКС в/в, госпитализация. НЕЛЬЗЯ: длительные системные ГКС при хронической крапивнице!",
    prognosis: "Острая: разрешение за дни–недели. Хроническая спонтанная: у 50% ремиссия в течение 1 года, у 80% — в течение 5 лет. 20% — персистирующее течение >5 лет. Омализумаб эффективен у 65–80% резистентных к антигистаминным. Ангиоотёк гортани — жизнеугрожающее состояние."
  },
  {
    name: "Микозы кожи", category: "Инфекционное", prevalence: "20–25% населения", icon: "🟤",
    color: "from-lime-50 to-green-50", badge: "bg-lime-100 text-lime-700",
    icd: "B35–B36",
    definition: "Группа инфекционных заболеваний кожи, волос и ногтей, вызываемых патогенными и условно-патогенными грибами. Включают дерматофитии, кандидоз кожи и отрубевидный (разноцветный) лишай.",
    etiology: "Дерматофиты: Trichophyton rubrum (70%), T. mentagrophytes, Microsporum canis, Epidermophyton floccosum. Дрожжи: Candida albicans (складки, слизистые), Malassezia furfur (отрубевидный лишай). Факторы риска: повышенная влажность, потливость, тесная обувь, сахарный диабет, иммуносупрессия, контакт с животными (M. canis), посещение бассейнов/саун.",
    pathogenesis: "Дерматофиты продуцируют кератиназы → разрушение кератина рогового слоя, волос, ногтей. Колонизация → воспалительная реакция (различная по интенсивности). T. rubrum — минимальное воспаление, хроническое течение. Зоофильные дерматофиты (M. canis) — выраженное воспаление, керион. Malassezia → изменение пигментации (азелаиновая кислота, УФ-фильтрация).",
    clinicalFeatures: "Tinea corporis: кольцевидные бляшки с приподнятым шелушащимся краем и разрешением в центре. Tinea pedis: межпальцевая мацерация, «мокасиновый» тип (гиперкератоз подошв). Tinea capitis: очаги алопеции с обломанными волосами, шелушение (дети!). Tinea unguium (онихомикоз): утолщение, пожелтение, крошение ногтей (дистально-латеральная форма — 90%). Отрубевидный лишай: гипо/гиперпигментированные пятна с отрубевидным шелушением на туловище.",
    diagnostics: "KOH-микроскопия: соскоб чешуек + 10–20% KOH → выявление гиф/спор (быстрый метод). Лампа Вуда: M. canis — зелёное свечение, отрубевидный лишай — золотисто-жёлтое. Культуральное исследование: посев на среду Сабуро (2–4 нед) — идентификация возбудителя. Дерматоскопия онихомикоза: зазубренный проксимальный край, «руины» ногтевого ложа. Гистология при сомнительных случаях (PAS-окраска).",
    differentialDiagnosis: "Tinea corporis: кольцевидная гранулёма (без шелушения), розовый лишай (медальон), нуммулярная экзема (мокнутие), псориаз. Tinea capitis: алопеция ареата (гладкая кожа), себорейный дерматит. Онихомикоз: псориаз ногтей (напёрстковидные вдавления, масляное пятно), травматическая ониходистрофия, красный плоский лишай. Отрубевидный лишай: витилиго (депигментация без шелушения), вторичный сифилис.",
    treatment: "Локализованные дерматофитии: топические антимикотики — тербинафин крем 1% или кетоконазол 2%, 2–4 нед. Распространённые / Tinea capitis / онихомикоз: системная терапия. Тербинафин per os: 250 мг/д (Tinea capitis 4–8 нед, онихомикоз стоп 3 мес, кистей 6 нед). Итраконазол: пульс-терапия 200 мг × 2 р/д, 1 нед/мес, 3 пульса (ногти стоп). Гризеофульвин: Tinea capitis у детей (M. canis) 20 мг/кг/д, 8–12 нед. Отрубевидный лишай: кетоконазол шампунь 2% / сертаконазол, при рецидивах — итраконазол 200 мг/д 5–7 дней.",
    prognosis: "Дерматофитии кожи: хороший прогноз, рецидивы при несоблюдении гигиены. Онихомикоз: излечение 70–80% (тербинафин), рецидивы 15–20%. Tinea capitis: полное излечение, но необходима системная терапия. Отрубевидный лишай: частые рецидивы (до 60%), профилактика противогрибковым шампунем. Факторы неудачи: иммуносупрессия, сахарный диабет, нарушение комплаенса."
  },
];
